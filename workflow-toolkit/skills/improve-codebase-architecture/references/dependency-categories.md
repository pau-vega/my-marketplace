...
Third-party services (Stripe, Twilio, etc.) not under your control. Mock at the boundary. The deepened module takes the external dependency as an injected port, and tests provide a mock implementation.
